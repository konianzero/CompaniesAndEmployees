...
public enum EmployeeHeaders {
    ID {
        @Override public String getHeader() { return "ID"; }
    },
    FULL_NAME {
        @Override public String getHeader() { return "ФИО"; }
    },
    BIRTH_DATE {
        @Override public String getHeader() { return "Дата Рождения"; }
    },
    EMAIL {
        @Override public String getHeader() { return "Электронная почта"; }
    },
    COMPANY {
        @Override public String getHeader() { return "Компания"; }
    };
